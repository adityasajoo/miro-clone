...
interface SelectionBoxProps {
    onResizeHandlerPointerDown: (corner:Side, initialBound:XYWH) => void;
};
...
const SelectionBox = memo(({
    ...
    return <>
        <rect className="pointer-events-none fill-transparent pointer pointer stroke-1 stroke-blue-500" 
            style={{
